...
namespace OblDatabaseOpgave
{
    public class BookingsViewsController : ApiController
    {
        ...
        public IHttpActionResult PostBookingsView(BookingsView bookingsView)
        {
            ...
            {
                if (BookingsViewExists(bookingsView.Booking_id))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = bookingsView.Booking_id }, bookingsView);
        }
        ...
        {
            return db.BookingsViews.Count(e => e.Booking_id == id) > 0;
        }
    }
}